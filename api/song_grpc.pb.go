...
const (
	SongService_GetSong_FullMethodName = "/api.SongService/GetSong"
)
...
type SongServiceClient interface {
	GetSong(ctx context.Context, in *SongQueryRequest, opts ...grpc.CallOption) (*SongQueryResponse, error)
}
...
func (c *songServiceClient) GetSong(ctx context.Context, in *SongQueryRequest, opts ...grpc.CallOption) (*SongQueryResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SongQueryResponse)
...
type SongServiceServer interface {
	GetSong(context.Context, *SongQueryRequest) (*SongQueryResponse, error)
...
func (UnimplementedSongServiceServer) GetSong(context.Context, *SongQueryRequest) (*SongQueryResponse, error) {
...
func _SongService_GetSong_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SongServiceServer).GetSong(ctx, req.(*SongQueryRequest))
	}
